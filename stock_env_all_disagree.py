...
class stock:
    ...
    def __init__(self, df, init_money=10000000, window_size=24):
        ...
        self.n_features = (window_size-1) * 63 + 1  # 特征数量
        ...
        self.use_Coal = df['use_Coal'].values
        ...
        self.use_Copper = df['use_Copper'].values
        ...
        self.use_DJI = df['use_DJI'].values
        ...
        self.use_Gold = df['use_Gold'].values
        ...
        self.use_gas = df['use_gas'].values
        ...
        self.use_Nasdaq = df['use_Nasdaq'].values
        ...
        self.use_solar = df['use_solar'].values
        ...
        self.use_wind = df['use_wind'].values
    ...
    def get_state(self, t):  # 某t时刻的状态
        ...
        block.append(self.use_Coal[d: t + 1])
        ...
        block.append(self.use_Copper[d: t + 1])
        ...
        block.append(self.use_TU[d: t + 1])
        ...
        block.append(self.use_TY[d: t + 1])
        ...
        block.append(self.use_DJI[d: t + 1])
        ...
        block.append(self.use_Gold[d: t + 1])
        ...
        block.append(self.use_gas[d: t + 1])
        ...
        block.append(self.use_Nasdaq[d: t + 1])
        ...
        block.append(self.use_solar[d: t + 1])
        ...
        block.append(self.use_wind[d: t + 1])
        ...
        for i in range(window_size-1):
            ...
            for multiplier in range(1, 63):  # 从1到64
