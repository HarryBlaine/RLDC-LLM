...
class stock:
    ...
    def __init__(self, df, init_money=10000000, window_size=24):
        ...
        self.n_features = (window_size-1) * 51 + 1  # 特征数量
        ...
        # self.close_Brent = df['close_Brent'].values
        # self.volume_Brent = df['volume_Brent'].values
        # self.high_Brent = df['high_Brent'].values
        # self.low_Brent = df['low_Brent'].values
        # self.open_Brent = df['open_Brent'].values
        ...
        # self.close_Dollars = df['close_Dollars'].values
    ...
    def get_state(self, t):  # 某t时刻的状态
        ...
        # 处理Brent相关数据
        # block.append(self.open_Brent[d: t + 1])
        # block.append(self.high_Brent[d: t + 1])
        # block.append(self.low_Brent[d: t + 1])
        # block.append(self.close_Brent[d: t + 1])
        # block.append(self.volume_Brent[d: t + 1])
        ...
        # 处理Dollars相关数据
        # block.append(self.close_Dollars[d: t + 1])
        ...
        for i in range(window_size-1):
            ...
            for multiplier in range(1, 51):  # 从1到64
